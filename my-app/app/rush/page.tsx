...
export default function RushPage() {
  ...
  const checkpoints = [
    ...
    { title: "DEI EVENT", header: "January 21, 6PM-7:30PM @ Trotter Multicultural Center", description: "Learn more about the unique backgrounds of brothers that makes AKPsi a diverse melting pot of cultures from around the world. This event is generally more serious, and we ask that you help us maintain a respectful and professional environment throughout the event." },
    { title: "WINTER OLYMPICS", header: "January 22, 6PM-8PM @ TBD", description: "Participate in winter olympics to play themed games and have fun with the brothers! This is a great opportunity to get a true experience of social events within AKPsi." },
