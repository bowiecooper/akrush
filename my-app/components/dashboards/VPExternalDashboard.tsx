...
type VPExternalDashboardProps = {
  userData: UserData;
};

export default async function VPExternalDashboard({ userData }: VPExternalDashboardProps) {
    ...
    <section className="pt-32 pb-20 bg-[#E5F2FF] flex-1">
      <div className="mx-auto max-w-7xl px-6 h-full">
        <h1 className="text-3xl md:text-5xl font-extrabold text-[#4D84C6] text-center mb-12">
          VP EXTERNAL DASHBOARD
        </h1>
        
        <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-[#4D84C6] mb-4">Welcome, {userData.full_name}!</h2>
          <p className="text-black mb-6">
            This is your VP External dashboard. Here you have access to manage external relations, rush events, and recruitment activities.
          </p>
