        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-black mb-2">Brotherhood Resources</h3>
              <p className="text-black">Access brotherhood resources and information here.</p>
            </div>
            
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-black mb-2">Events & Activities</h3>
              <p className="text-black">View upcoming events and activities.</p>
            </div>
          </div>
        </div>
      </div>
