...
type MemcoDashboardProps = {
  userData: UserData;
};

export default async function MemcoDashboard({ userData }: MemcoDashboardProps) {
      ...
      <div className="mx-auto max-w-7xl px-6 h-full">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
          ...
          <p className="text-black mb-6">
            This is your membership committee dashboard. Here you can manage rush applications and review rushees.
          </p>
