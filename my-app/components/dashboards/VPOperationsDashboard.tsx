...
type VPOperationsDashboardProps = {
  userData: UserData;
};

export default async function VPOperationsDashboard({ userData }: VPOperationsDashboardProps) {
      ...
      <div className="mx-auto max-w-7xl px-6 h-full">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
          ...
          <p className="text-black mb-6">
            This is your VP Operations dashboard. Here you have access to manage operational processes, logistics, and day-to-day fraternity operations.
          </p>
